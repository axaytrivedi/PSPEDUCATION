                ...
                $.ajax({   
                    ...
                    success: function(data) {
                            ...
                            for(var k=0; k < data[0].length; k++)
                            {
                                ...
                                if( data[0][k].noHoursLectures != null)
                                {  
                                    noHoursLectures = data[0][k].noHoursLectures;
                                }
                                else
                                {
                                      noHoursLectures=0;
                                }
                                tbldata += '<tr><td>'+count+'</td><td>'+data[0][k].FacultyCode+'</td><td>'+data[0][k].FirstName.toUpperCase()+' '+data[0][k].LastName.toUpperCase()+'</td><td>'+data[0][k].attInHrs.replace('.000000', '')+'</td><td>'+noHoursLectures+' hrs</td></tr>';
                                count++;        
                            }
