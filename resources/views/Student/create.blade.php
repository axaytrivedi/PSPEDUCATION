                                    ...
                                    @if(!empty($edit_students->id)) @method('PATCH') @endif @csrf
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                name="CourceCode" value="{{ old('CourceCode', isset($edit_students->CourceCode) ?  $edit_students->CourceCode  : '' ) }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label  class="form-label">Batch Code</label>
                                                <input type="text" class="form-control" id="BatchCode" 
                                                name="BatchCode" value="{{ old('BatchCode', isset($edit_students->BatchCode) ?  $edit_students->BatchCode  : '' ) }}">
                                            </div>
                                            <div class="col-md-6">
